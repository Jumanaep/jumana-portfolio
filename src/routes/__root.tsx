...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Jumana Fathima EP — Software QA Engineer" },
      {
        name: "description",
        content:
          "Software QA Engineer specialising in manual and automation testing with Selenium, Playwright and Postman.",
      },
      { name: "author", content: "Jumana Fathima EP" },
